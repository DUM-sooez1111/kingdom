(() => {
  ...
  const TUTORIAL_PAGES = [
    ...
    { kicker:'제2장 · 카메라', title:'왕국을 자유롭게 둘러보기', lead:'높은 시점에서 영토 전체를 살펴보고 원하는 장소로 이동하세요.', tips:[['이동','<kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd>로 화면을 이동합니다.'],['카메라 각도','<kbd>F</kbd>로 지면을 더 내려다보고 <kbd>R</kbd>로 카메라 각도를 다시 위로 올립니다.'],['좌우 회전','<kbd>Q</kbd>와 <kbd>E</kbd>로 카메라 방향을 좌우로 회전합니다.'],['확대와 이동','마우스 휠로 확대·축소하고 오른쪽 버튼을 누른 채 드래그해 이동합니다.']] },
